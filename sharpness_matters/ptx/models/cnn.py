...
class CNNBinaryClassifier(pl.LightningModule):
    """
    PyTorch Lightning module for binary classification using CNN architectures.
    """
    ...
    def __init__(
        ...
        """
        Initialize CNN binary classifier.

        Args:
            lr (float): Learning rate for optimizer
            fold (int): Cross-validation fold number
            img_size (int): Input image size
            model_name (str): Model architecture (densenet121 or resnet152.a2_in1k)
        ...
        # Reinitialize weights for the new convolutional layer
    ...
    def training_step(self, batch: dict, batch_idx: int) -> torch.Tensor:
        ...
        Args:
            batch (dict): Batch containing 'data' and 'label'
    ...
    def on_validation_epoch_end(self):
        ...
        Calculates AUC and F1 score from accumulated predictions.
        """
